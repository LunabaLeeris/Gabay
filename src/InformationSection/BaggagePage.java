    ...
    public BaggagePage() {
        ...
        nextButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                FlightDetailsDirect FlightDetailsDirect = new FlightDetailsDirect(currentUserInfo);
                removeAll();
                add(FlightDetailsDirect);
                revalidate();
                repaint();
            }
        });
        ...
        button.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (button == noBaggageButton) {
                    ...
                    Hashtable<String, String> currentUserInfo = Passenger.getCurrentUserInfo();
                    BaggageAdd baggageAddPanel = new BaggageAdd(currentUserInfo);
                    removeAll();
                    add(baggageAddPanel);
                    revalidate();
                    repaint();
