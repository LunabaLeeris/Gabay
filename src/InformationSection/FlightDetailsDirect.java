...
public class FlightDetailsDirect extends ImagePanel {
	...
	public FlightDetailsDirect(Hashtable<String, String> passengerInfo) {
		...
		routeLabel.setBounds(13, 20, 300, 44);
		...
		referenceNumber.setBounds(250, 5, 189, 12);
		header.add(referenceNumber);

		content.add(header);
		List<Path> path = new ArrayList<>();
		path.add(new Path("philippines to india", 10, 10, 10));
		path.add(new Path("india to madagascar", 10, 10, 10));
		...
		this.add(content);
		System.out.println(content.getHeight());
		setSize(new Dimension(430, 225 + content.getHeight() + 350));
